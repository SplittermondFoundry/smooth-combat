...
$stagePath = Join-Path $outputPath "preview-2/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.2"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-2.zip'
