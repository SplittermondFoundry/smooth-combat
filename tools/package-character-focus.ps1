...
$stagePath = Join-Path $outputPath "preview-5/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.5"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-5.zip'
