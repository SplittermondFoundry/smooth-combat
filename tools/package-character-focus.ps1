...
$stagePath = Join-Path $outputPath "preview/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.1"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview.zip'
