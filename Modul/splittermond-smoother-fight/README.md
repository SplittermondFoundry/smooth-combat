...
- Foundry-basierte Bewegungsverfolgung mit freier Bewegung, Laufen, Sprinten, Überziehungswarnung, regelgerechter Bewegung entlang der gewählten Route bei Tick 3/5 beziehungsweise 3/5/7/10 sowie parallel und standardmäßig dauerhaft eingeblendeten, tokenfarbigen Routen mit ganzzahligen Meilensteinen, Hover-Hervorhebung und Abbruch am nächstgelegenen Segment direkt im Kampf-HUD; die automatische Daueranzeige lässt sich pro Client abschalten
