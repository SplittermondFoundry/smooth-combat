...
$stagePath = Join-Path $outputPath "preview-3/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.3"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-3.zip'
