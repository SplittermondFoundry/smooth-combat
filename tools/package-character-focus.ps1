...
$stagePath = Join-Path $outputPath "preview-6/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.6"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-6.zip'
