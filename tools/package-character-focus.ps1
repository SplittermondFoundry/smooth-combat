...
$stagePath = Join-Path $outputPath "preview-9/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.9"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-9.zip'
