...
$stagePath = Join-Path $outputPath "preview-4/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.4"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-4.zip'
