...
$stagePath = Join-Path $outputPath "preview-8/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.8"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-8.zip'
