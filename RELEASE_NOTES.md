# Splittermond Smoother Fight 0.6.4
...
- Kontrollierte Operationszählung: 60 Animations-/Sichtframes bei unverändertem Sichtbestand erzeugen **0 statt 60 vollständige HUD-Aufrufe**; 60 HUD-Distanzabrufe derselben Bewegungshistorie benötigen **1 statt 60 Pfadmessungen**. Diese Werte sind keine CPU-/GPU-Messung der laufenden Spielwelt. Einzelheiten: [Leistungsprüfung der Tokenbewegung](https://github.com/SplittermondFoundry/smooth-combat/blob/v0.6.4/docs/token-movement-performance.md).
