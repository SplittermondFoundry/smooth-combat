...
$stagePath = Join-Path $outputPath "preview-7/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.7"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-7.zip'
