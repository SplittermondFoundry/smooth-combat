...
$stagePath = Join-Path $outputPath "preview-10/$moduleId"
...
$manifest.version = "$($manifest.version)-character-focus.10"
...
$previewZip = Join-Path $outputPath 'smoother-fight-character-focus-preview-10.zip'
